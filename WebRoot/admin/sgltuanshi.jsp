...
<body ng-app="app">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-10">
				<ol class="breadcrumb">
					<li class="active">团史团识</li>
					<li class="active">查看</li>
				</ol>
				<div id="Mybtns" ng-controller="companyController">
					<a href="TSTSadd.jsp" class="btn btn-info btn-fl">添加</a>
					<div>
							...
							<table class="table table-striped text-center">
								...
								<tbody id="demo">
									<tr v-for="data in datas" id="data.id">
										...
										<td><a :href="'TSTSchange.jsp?id='+data.id">修改</a></td>
										<td><a @click="del(data)">删除</a></td>
									</tr>
								</tbody>
							</table>
						</div>
						<div id="btn btn-info center-block" class="btn btn-info center-block"
							 style="width:100px;"
					...
					$
						.ajax({
							...
							success : function(data) {
								...
								if (data[0].data.length >= 10) {
									document
										.getElementById("btn btn-info center-block").style.visibility = "visible";
								} else {
									document
										.getElementById("btn btn-info center-block").style.display = "none";
								}
