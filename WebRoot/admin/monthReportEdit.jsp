	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<label for="exampleInputPassword1">本月工作总结:</label>
				<br/>
				<textarea id="summary" style="width:1000px;height:220px;"></textarea>
				
				
				<!--input type="text" style="width:1000px;height:220px;" id="mytextEditor" /-->
				<!--script type="text/plain" id="myEditor"
					style="width:1000px;height:220px;">

				</script-->
				<br/>
				<label for="exampleInputPassword1">下月工作计划:</label>
				<textarea id="plan" style="width:1000px;height:220px;"></textarea>
			...
			<div class="clear"></div>
				<div id="btns">
					<table>
						<tr>
							<td>
								<button class="btn" onclick="getContent(1)">保存</button>&nbsp;<button class="btn" onclick="getContent(2)">提交</button></td>
						</tr>
					</table>
				</div>
				...
				<script type="text/javascript">
					...
					$.ajax({
								...
								success : function(data) {
									...
									document.getElementById("summary").value = data[0].data.summary;
									document.getElementById("plan").value = data[0].data.plan;
					...
					function getContent(status) {
						var arr = [];
						arr.push(document.getElementById("summary").value);
						
						var arr2 = [];
						arr2.push(document.getElementById("plan").value);
