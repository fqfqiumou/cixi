				...
				<div id="Mybtns">
					...
					<div>
						<form method="post" id="tf" enctype="multipart/form-data"
							...
							<div class="form-group">
								<label for="exampleInputFile">新闻图片:</label> <input id="file"
									type="file" name="file">
...
<script type="text/javascript">
	...
	function getContent() {
		...
		if (document.getElementById("file").value == null || document.getElementById("file").value == "" || document.getElementById("file").value.length <= 0) {
			alert("图片不允许为空");
			return;
		}
