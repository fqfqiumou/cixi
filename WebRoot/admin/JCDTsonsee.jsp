    ...
    <p>这里我可以写一些输入提示</p>
				...
				<div id="btns">
					<table>
						<tr>
							<td>
								<button id="submitbtn" class="btn" onclick="getContent()">提交</button>
							</td>
							<c:if  test="${sessionScope.useradmin.power==413}">
								<td>
									<button id="passbtn" class="btn" onclick="pass()">通过</button>&nbsp;
								</td>
								<td>
									<button id="rejectbtn" class="btn" onclick="reject()">驳回</button>&nbsp;
								</td>
							</c:if>
						</tr>
					</table>
