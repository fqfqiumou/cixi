...
<body ng-app="app">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<script id="myEditor" type="text/plain" style="width:1024px;height:500px;">
				</script>
    ...
    <p>这里我可以写一些输入提示d</p>
				...
				//实例化编辑器
			    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('myEditor')就能拿到相关的实例
			    ...
			    function setContent(isAppendTo) {
			        ...
			        UE.getEditor('myEditor').setContent('欢迎使用ueditor', isAppendTo);
			        alert(arr.join("\n"));
			    }
