		...
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<div class="form-group">
					<label for="exampleInputPassword1">标题:</label> <input id="name" type="text"
						style="width:20%" class="form-control" name="company.redistheme">
				</div>
				...
				<div id="btns">
					<table>
						<tr>
							<td>
								<button class="btn" onclick="xg()">提交</button>&nbsp;
							</td>
						</tr>
					</table>
				</div>
