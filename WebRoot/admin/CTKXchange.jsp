			...
			<div class="col-sm-10">
				...
				<script type="text/javascript">
					...
					function getContent() {
						...
						if (document.getElementById("title").value == null || document.getElementById("title").value.length <= 0) {
							alert("标题不允许为空");
							return;
						}
						$.ajax({
							url : "updateNewsflash.do",
							data : {
								Id : id,
							...
							success : function(data) {
								...
								window.setTimeout("window.location='sglfastMessage.jsp'", 1000);
							}
						});
					}
					...
					function getText() {
						...
						var range = UM.getEditor('myEditor').selection
							.getRange();
						range.select();
